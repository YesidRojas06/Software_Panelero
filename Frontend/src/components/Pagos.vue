<template>
    <div>
      <div class="q-pa-md">
        <q-btn color="white" text-color="black" label="Agregar Pago" @click="guardar"/>
  
        <q-table title="Pagos" :rows="rows" :columns="columns">
  ...
  let columns = ref([
    ...
    { name: 'Medio de pago', label: 'Medio de pago', field: 'medio de pago', align: "center" },
    { name: 'Valor pago', label: 'Valor pago', field: 'valor pago', align: "center" },
